package ninda.sabilla.chromeinc.network;


import java.util.ArrayList;

import ninda.sabilla.chromeinc.network.response.BarangResponse;
import ninda.sabilla.chromeinc.network.response.CustomerResponse;
import ninda.sabilla.chromeinc.network.response.InventoryBaruResponse;
import ninda.sabilla.chromeinc.network.response.InventoryResponse;
import ninda.sabilla.chromeinc.network.response.LoginResponse;
import ninda.sabilla.chromeinc.network.response.TransaksiBaruResponse;
import ninda.sabilla.chromeinc.network.response.TransaksiDetailResponse;
import ninda.sabilla.chromeinc.network.response.TransaksiResponse;
import ninda.sabilla.chromeinc.network.response.TransaksiUpdateStatusResponse;
